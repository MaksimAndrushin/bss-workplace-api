...
func (c *BusinessWorkplaceCommander) Get(ctx context.Context, inputMessage *tgbotapi.Message) {
	...
	workplace, err := c.workplaceService.Describe(ctx, uint64(workplaceID))
	if err != nil {
