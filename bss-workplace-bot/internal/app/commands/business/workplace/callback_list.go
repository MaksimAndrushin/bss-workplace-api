...
func (c *BusinessWorkplaceCommander) CallbackList(ctx context.Context, callback *tgbotapi.CallbackQuery, callbackPath path.CallbackPath) {
	...
	c.processList(ctx, parsedData.Offset, parsedData.Limit, callback.Message.Chat.ID)
}
