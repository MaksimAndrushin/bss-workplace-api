...
func (c *BusinessWorkplaceCommander) Delete(ctx context.Context, inputMessage *tgbotapi.Message) {
	...
	deleted, err := c.workplaceService.Remove(ctx, uint64(workplaceID))
	if err != nil {
