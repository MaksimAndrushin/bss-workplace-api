...
func (c *BusinessWorkplaceCommander) Edit(ctx context.Context, inputMessage *tgbotapi.Message) {
	...
	if err := c.workplaceService.Update(ctx, workplace.ID, workplace); err != nil {
